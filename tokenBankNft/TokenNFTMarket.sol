...
contract  NFTMarket is HookERC20{
    ...
    function buy(address _nftToken,address _erc20Token,uint256 _tokenId) external {
        ...
        bool success = ERC20(_erc20Token).transferFrom(msg.sender,erc20Receive,price);
        if (success) {
